...
class Video(object):
	def __init__(self):
		...
		self.model = load_model("C:\\Users\\sakth\\Downloads\\Real-Time-Communication-Specially-Abled-main (1)\\Real-Time-Communication-Specially-Abled-main\\ProjectFiles\\Training_File\\asl_model.h5") # Execute Local Trained Model
